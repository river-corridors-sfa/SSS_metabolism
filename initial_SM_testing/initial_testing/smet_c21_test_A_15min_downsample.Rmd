...
setwd(data.path)
 dat = read.csv("SSS_MiniDOT_C21_with_Depth.csv",header=T) #---------------------------------------------------------------------------------------------
  file.name = 'C21_test1_15min_downsample'
  #dat = na.omit(dat)
...
# Changing the specs
bayes_specs = specs(bayes_name, K600_daily_meanlog_meanlog=log(34.1937800448741), K600_daily_meanlog_sdlog=0.7, K600_daily_sdlog_sigma=0.1, burnin_steps=1000, 
                  saved_steps=1000)
...
load("~/GitHub/gitlab/SSS_metabolism/initial_SM_testing/c21_15min.RData")
