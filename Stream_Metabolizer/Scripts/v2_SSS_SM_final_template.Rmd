...
sites = c('T02','S37','S10','S15','U20', 'S39') # Run at 0.08
...
if (SITE_ID %in% sites){
  ...
  bayes_specs = specs(bayes_name, K600_daily_meanlog_meanlog=log(K600estimate), K600_daily_meanlog_sdlog=0.7, K600_daily_sdlog_sigma=0.1, burnin_steps=2000, 
                  saved_steps=2000) 
}else {
