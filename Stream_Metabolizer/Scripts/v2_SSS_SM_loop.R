...
rm(list=ls(all=T))
metadata.path="C:/Users/gara009/OneDrive - PNNL/Documents/GitHub/SSS_metabolism/v3_SSS_Data_Package/" #from this data package: https://data.ess-dive.lbl.gov/datasets/doi:10.15485/1969566
...
for(i in 37:length(SITE_LIST[,1])) { 
  ...
  if (i ==10){ # 23 had the same issue
    next # skipping this site while we figure why it doesn't have depth
  }
