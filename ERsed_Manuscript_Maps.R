...
metadata_file <- 'C:/Users/forb086/Downloads/v2_RCSFA_Geospatial_Data_Package/v2_RCSFA_Geospatial_Site_Information.csv'

data_file <- 'Z:/00_Cross-SFA_ESSDIVE-Data-Package-Upload/01_Data-Package-Folders/SSS_Ecosystem_Respiration_Data_Package/SSS_Ecosystem_Respiration_Data_Package/SSS_Water_Sediment_Total_Respiration.csv'

shp_dir <- 'C:/Brieanne/Maps/YakimaRiverBasin_Boundary'
