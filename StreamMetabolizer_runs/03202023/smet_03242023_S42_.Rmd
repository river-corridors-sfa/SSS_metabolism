...
output.path="C:/Users/kauf093/OneDrive - PNNL/Documents/GitHub/gitlab/SSS_metabolism/StreamMetabolizer_runs/03202023"
 
 #---------------------------------------------------------------------------------------------
  file.name = paste(SITE,'_032423',sep='')
  #dat = na.omit(dat)
...
#trim out posibly-biofouled data after 8/18
...
# Changing the specs
bayes_specs = specs(bayes_name, K600_daily_meanlog_meanlog=log(K600estimate), K600_daily_meanlog_sdlog=0.7, K600_daily_sdlog_sigma=0.0000000001, burnin_steps=1000, 
                  saved_steps=1000)
