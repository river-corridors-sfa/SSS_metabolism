---
title: "S31_15_minute_downsample_sigma_0.02"
author: "kaufman"
date: "`r Sys.Date()`"
...
setwd(data.path)
 dat = read.csv("SSS_MiniDOT_S31_with_Depth.csv",header=T) #---------------------------------------------------------------------------------------------
  file.name = 'S31_test1_15_minute_downsample_sigma_0.02'
  #dat = na.omit(dat)
...
# Changing the specs
bayes_specs = specs(bayes_name, K600_daily_meanlog_meanlog=log(24.9396659809312), K600_daily_meanlog_sdlog=0.7, K600_daily_sdlog_sigma=0.02, burnin_steps=1000, 
                  saved_steps=1000)
