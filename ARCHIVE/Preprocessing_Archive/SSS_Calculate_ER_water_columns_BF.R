...
findir<- 'C:/Users/forb086/Downloads/SSS_Data_Package/'
##########################################################################
## DO slope
DO_summary<-read_csv(file.path(findir,'miniDOTManualChamber/Plots_and_Summary_Statistics','SSS_Water_DO_Temp_Summary.csv'), skip = 48, na = c('N/A', -9999))
...
# mean depth
mean_depth<- read_csv('C:/Users/forb086/OneDrive - PNNL/Spatial Study 2022/SSS_Data_Processing/SSS_Average_Reach_Depth_2023-05-16.csv')
...
#########################
ERtotal <- read_csv(file.path(sdir,'/StreamMetabolizer_runs/final_results','SSS_combined_SM_results.csv'))
...
write_csv(ERtotal,file.path(sdir,'SM_analysis','combined_results_2023-05-16.csv'))
