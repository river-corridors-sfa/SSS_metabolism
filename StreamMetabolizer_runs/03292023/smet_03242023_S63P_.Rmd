...
DOdo = setNames(data.frame(tt,dat$Date_Time_PST,DO,DO361),c("unixtime","Date_Time_PST","DO","Fourier361"))
...
dat$DO_mg_per_L<-DOdo$error_reduced
...
#identify and replace erroneous data
#dat$rollmean<-rollmean(dat$DO.obs, 5, fill = NA)
